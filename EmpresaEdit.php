...
$empresa->setID_Empresa($_GET['alt']);
$empresa->load();

$regEmpresa = array('COD_CNPJ' => $empresa->getCOD_CNPJ(), 'DSC_RazaoSocial' => $empresa->getDSC_RazaoSocial(), 'DSC_Endereco' => $empresa->getDSC_Endereco(), 'DSC_Bairro' => $empresa->getDSC_Bairro(), 'DSC_Cidade' => $empresa->getDSC_Cidade(), 'NUM_CEP' => $empresa->getNUM_CEP(), 'NUM_InscricaoEstadual' => $empresa->getNUM_InscricaoEstadual(), 'NUM_Fone' => $empresa->getNUM_Fone(), 'NUM_FAX' => $empresa->getNUM_FAX(), 'DSC_EMAIL' => $empresa->getDSC_EMAIL(), 'COD_TipoEstado' => $empresa->getCOD_TipoEstado());
