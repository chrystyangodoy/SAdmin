...
if (isset($_POST['Salvar']))
{
    ...
    $eventoCateg->setVLR_Inscricao($eventoCateg->moedaToUS($_POST['VLR_Inscricao']));
    $eventoCateg->setDT_Inicio_Valor($eventoCateg->dateToUS($_POST['DT_Inicio_Valor']));
    $eventoCateg->setDT_Fim_Valor($eventoCateg->dateToUS($_POST['DT_Fim_Valor']));
...
$smarty->assign("VLR_Inscricao", $eventoCateg->moedaToBR($eventoCateg->getVLR_Inscricao()));
$smarty->assign("DT_Inicio_Valor", $eventoCateg->dateToBR($eventoCateg->getDT_Inicio_Valor()));
$smarty->assign("DT_Fim_Valor", $eventoCateg->dateToBR($eventoCateg->getDT_Fim_Valor()));
