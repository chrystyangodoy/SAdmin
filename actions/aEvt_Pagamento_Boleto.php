...
class aEvt_Pagamento_Boleto extends mEvt_Pagamento_Boleto {
    ...
    protected $sqlUpdate = "update evt_pagamento set NUM_Boleto = '%s', COD_Barras_Boleto = '%s', ID_EVT_Pagamento = '%s' WHERE ID_Pagamento_Boleto = '%s'";
    protected $sqlDelete = "delete from evt_pagamento where ID_Pagamento_Boleto = '%s'";
