...
class aEvt_Curso extends mEvt_Curso {
    ...
    public function insert() {
        $sql = sprintf($this->sqlInsert, $this->getID_Curso(), $this->getCurso(), $this->getTituloCurso(), $this->getData_Hora(), $this->getID_EVT(), $this->getValor_Curso());
        return $this->RunQuery($sql);
    }

    public function update() {
        $sql = sprintf($this->sqlUpdate, $this->getCurso(), $this->getTituloCurso(), $this->getData_Hora(), $this->getID_EVT(), $this->getValor_Curso(), $this->getID_Curso());
        return $this->RunQuery($sql);
    }
