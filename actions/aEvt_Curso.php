...
class aEvt_Curso extends mEvt_Curso {
    ...
    protected $sqlInsert = "INSERT INTO evt_curso (ID_Curso, Curso, TituloCurso, Data_Hora, ID_EVT,Valor_Curso) VALUES ('%s','%s','%s','%s','%s','%s')";
    protected $sqlUpdate = "update evt_curso set Curso = '%s', TituloCurso = '%s', Data_Hora = '%s', ID_EVT = '%s', Valor_Curso = '%s' where ID_Curso = '%s'";
    ...
    public function insert() {
        $sql = sprintf($this->sqlInsert, $this->getID_Curso(), $this->getCurso(), $this->getTituloCurso(), $this->getData_Hora(True), $this->getID_EVT(), $this->getValor_Curso());
        return $this->RunQuery($sql);
    }

    public function update() {
        $sql = sprintf($this->sqlUpdate, $this->getCurso(), $this->getTituloCurso(), $this->getData_Hora(True), $this->getID_EVT(), $this->getValor_Curso(), $this->getID_Curso());
        return $this->RunQuery($sql);
    }
